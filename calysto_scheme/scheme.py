...
def b_proc_178_d(external_function_object):
    GLOBALS['value2_reg'] = fail_reg
...
def make_external_proc(external_function_object):
    return make_proc(b_proc_178_d, external_function_object)
